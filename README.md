...
Especificaciones del ModeloAnclaje Climático: Uso de datos históricos multidecadales (CHIRPS 1981-2025) para la calibración del presente real.

Proyección Futura: Ensamble multimodelo de 15 modelos de circulación global (CMIP6) bajo el escenario de emisiones altas (SSP5-8.5).

Hidrología Física: Integración de curvas IDF (Intensidad-Duración-Frecuencia) de la estación INAMHI M0056 (Guayaquil Aeropuerto).

Análisis HAND (Height Above Nearest Drainage): Normalización topográfica basada en el modelo MERIT Hydro para determinar la vulnerabilidad geomorfológica.
